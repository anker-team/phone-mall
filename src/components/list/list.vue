            ...
            <div class="main list-main hasfixbar">
                <div class="list-wrap">
                    <div class="list-tooltop">
                        <div class="list_m">
                            <span class="m_item active" v-for = "(item,index) in list" v-if = "index == curr_num" v-on:click="goList(index)">
                              <img :src="item.img" alt="" />
                            </span>
                            <span class="m_item" v-else v-on:click="goList(index)">
                              <img :src="item.img" alt="" />
                            </span>
                        </div>
                    </div>
...
export default {
  ...
  mounted() {
    ...
    this.$http.get('/api/list').then(function(res){
        ...
        console.log(res.body.listdata[0].children);
        me.list = res.body.listdata;
